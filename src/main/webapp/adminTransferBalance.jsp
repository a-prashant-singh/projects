	...
	<main id="main-content">
		<section>
			...
			<form name=F1 onSubmit="return dil(this)"
				action="AdminTransferBalanceServlet" method="post">
				<fieldset>

					<div class="form-group">
						<label for="accountno">SENDER ACCOUNT NO:</label> <input
							type="text" name="accountno" pattern="[0-9]{13}" required
							placeholder="16**********">
					</div>
					<div class="form-group">
						<label for="accountno">RECIPEINT ACCOUNT NO:</label> <input
